    ...
    return (
        <>
            <button
                ...
                onClick={() => openModal()}
                aria-label={`Hey ho`}
                className="flex items-center justify-center w-2/3 px-5 py-3 transition-colors bg-purple-600 border border-purple-600 rounded-lg hover:bg-transparent group focus:outline-none focus:ring"
            >
